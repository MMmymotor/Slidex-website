#!/usr/bin/env python3
"""
Script pour corriger les footers des pages index (racine et blog)
"""

import re

# Footer de référence pour index.html (profondeur 0 - racine)
FOOTER_INDEX_ROOT = '''<footer class="footer-v2 footer-large pd-top-large-v2" style="background-color: #171717;">
      ...
      <div id="w-node-_4f08d2cd-5c61-64e6-3cc5-bddc030e84c2-57241a43">
        ...
        <div class="w-layout-grid grid-1-column footer-grid-v2">
          <ul class="list-wrapper" data-w-id="4f08d2cd-5c61-64e6-3cc5-bddc030e84c7" role="list" style="font-size: calc(1em + 1px);">
            ...
            <li class="list-item">
              <a class="link neutral w-inline-block" href="product-detail-2-vantaux.html">
                <div class="display-3">Deux vantaux</div>
              </a>
            </li>
            <li class="list-item">
              <a class="link neutral w-inline-block" href="telescopique-bientot-disponible.html">
        ...
        <div>
          <div class="overflow-hidden title-wrap">
            <div class="w-layout-grid grid-auto-1fr">
              <div><img alt="Location Icon" loading="eager" src="images/location-icon-homerepair-x-webflow-template.svg"/></div>
        ...
        <div>
          <div class="overflow-hidden title-wrap">
            <div class="w-layout-grid grid-auto-1fr" data-w-id="4f08d2cd-5c61-64e6-3cc5-bddc030e851c">
              <div><img alt="Message Icon" loading="eager" src="images/message-icon-homerepair-x-webflow-template.svg"/></div>
...
# Footer pour blog/index.html (profondeur 1) - remplacer images/ par ../images/, etc.
FOOTER_BLOG_INDEX = FOOTER_INDEX_ROOT.replace('src="images/', 'src="../images/').replace('href="product-detail.html"', 'href="../product-detail.html"').replace('href="product-detail-2-vantaux.html"', 'href="../product-detail-2-vantaux.html"').replace('href="telescopique-bientot-disponible.html"', 'href="../telescopique-bientot-disponible.html"').replace('href="kits-renovation/', 'href="../kits-renovation/').replace('href="index.html"', 'href="../index.html"')

def replace_footer(file_path, new_footer):
    """Remplace le footer d'un fichier."""
    try:
        with open(file_path, 'r', encoding='utf-8') as f:
            content = f.read()
        
        # Pattern pour trouver le footer
...
# Mise à jour
base = "/Users/bastienpoggioli/kDrive/Common documents/Bastien - My Motor/PORTE AUTO/WEB/slidex-fixed"

print("📄 Mise à jour de index.html (racine)...")
replace_footer(f"{base}/index.html", FOOTER_INDEX_ROOT)

print("\n📄 Mise à jour de blog/index.html...")
replace_footer(f"{base}/blog/index.html", FOOTER_BLOG_INDEX)
